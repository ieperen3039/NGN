...
import static io.github.ieperen3039.ngn.UserInterface.Rendering.SFrameLookAndFeel.UIComponentType.SCROLL_BAR_BACKGROUND;
import static io.github.ieperen3039.ngn.UserInterface.Rendering.SFrameLookAndFeel.UIComponentType.SCROLL_BAR_DRAG_ELEMENT;
...
class SScrollBar extends SComponent implements MouseScrollListener {
    ...
    public SScrollBar(int minimum, int maximum, int current) {
        ...
        this.scrollUp = new SButton("/\\", SCROLL_BUTTON_PROPS, this::up);
        this.scrollDown = new SButton("\\/", SCROLL_BUTTON_PROPS, this::down);
    ...
    public SScrollBar addListener(SScrollBarListener listener) {
        listeners.add(listener);
        return this;
    }

    public SScrollBar removeListener(SScrollBarListener leaver) {
