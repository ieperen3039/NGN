...
//        glfwSetWindowIcon(newWindow, null); // TODO icon
    ...
    // poll for events, but do not update the window
    ...
    public record Settings(
        ...
        public Settings() {
            this(false, false, 1, false, 800, 600, false, 60, false, true);
        }

        public Settings(io.github.ieperen3039.ngn.Settings.Settings s) {
            this(
                    s.DEBUG, false,
