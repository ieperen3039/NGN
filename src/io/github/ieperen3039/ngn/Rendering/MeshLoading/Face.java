 ...
 */
 public class Face {
    ...
    public static Face createWithColors(int[] vertexIndices, int[] normalIndices, int[] colors) {
        return new Face(vertexIndices, normalIndices, null, colors);
    }

    public static Face createWithTexture(int[] vertexIndices, int[] normalIndices, int[] textureIndices) {
        return new Face(vertexIndices, normalIndices, textureIndices, null);
    }

    public static Face createWithTexture(int[] indices) {
        return new Face(indices, indices, indices, null);
    }
}
