...
public enum Logger {
    ...
    DEBUG,
    /** for errors caused by a break of assumptions in internal, where the simulation still could continue */
    ASSERT,
    /** for general information about the simulation state */
    INFO,
    /** for errors that allow the simulation to continue */
    WARN,
    /** for errors that probably cause the simulation to crash at some point */
    ERROR;
