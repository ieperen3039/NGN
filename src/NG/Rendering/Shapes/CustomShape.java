...
import NG.Rendering.MeshLoading.Face;
import NG.Rendering.MeshLoading.FlatMesh;
import NG.Rendering.MeshLoading.Mesh;
import NG.Rendering.MeshLoading.MeshFile;
import NG.Rendering.MeshLoading.SmoothMesh;
...
public class CustomShape {
    ...
    private void addFinalTriangle(Vector3fc A, Vector3fc B, Vector3fc C, Vector3fc normal) {
        ...
        faces.add(new Face(new int[]{aInd, bInd, cInd}, nInd));
    }
    ...
    public Mesh toSmoothMesh() {
        return new SmoothMesh(getSortedVertices(), normals, new ArrayList<>(), faces);
    }
